...
Parts of this script were written by Google Gemini (disclosed in comments below):

Examples:
 python openomb.py --start-date 2025-01-21 --stop-date 2025-07-21 --count-only
 python openomb.py --start-date 2025-01-21 --stop-date 2025-07-21 --json "omb-apportionments-takedown.json"
...
# This code-block was written by Google Gemini:
...
# Some parts of this code-block were written by Google Gemini:
...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--start-date", default="2025-01-21", help="Start date (YYYY-MM-DD). Default: 2025-01-21")
    ap.add_argument("--stop-date", default="2025-03-24", help="End date (YYYY-MM-DD). Default: 2025-03-24")
    ...
    ap.add_argument("--json", default=None, help="Optional path to save the raw JSON results returned by the API.")
...
def main() -> int:
    ...
    if args.json:
        with open(args.json, "w", encoding="utf-8") as f:json.dump(items, f, indent=2)
